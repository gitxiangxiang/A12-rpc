window._zhugeSdk = function (t) {
    ...
    0: function (t, e) {
        var n, i, o, r, s, a, c, u, d, p, l, h = window.navigator, f = window.document, g = h.userAgent,
            m = Array.prototype, v = Object.prototype, _ = v.toString, y = m.forEach, w = Array.isArray, k = m.slice,
            b = v.hasOwnProperty, S = {}, T = {
                each: function (t, e, n) {
                    if (null != t) if (y && t.forEach === y) t.forEach(e, n); else if (t.length === +t.length) {
                        for (var i = 0, o = t.length; i < o; i++) if (i in t && e.call(n, t[i], i, t) === S) return
                ...
                jsonp: function (t, e, n) {
                    var i = "cb" + Math.random().toString().split(".")[1], o = f.createElement("script");
                    o.src = t + "?callback=" + i, window[i] = function (t) {
                        e(t)
                    }, o.onerror = function () {
                        n()
                    }, f.head ? f.head.appendChild(o) : f.getElementsByTagName("head")[0].appendChild(o)
                },
                JSONEncode: function (t) {
                    var e = function (t) {
                        ...
                        switch (p && "object" == typeof p && "function" == typeof p.toJSON && (p = p.toJSON(t)), typeof p) {
                            ...
                            case"object":
                                if (!p) return "null";
                                if (o += "    ", d = [], "[object Array]" === _.apply(p)) {
                                    for (c = p.length, r = 0; r < c; r += 1) d[r] = n(r, p) || "null";
                                    return a = 0 === d.length ? "[]" : o ? "[\n" + o + d.join(",\n" + o) + "\n" + u + "]" : "[" + d.join(",") + "]", o = u, a
                                }
                                for (s in p) b.call(p, s) && (a = n(s, p)) && d.push(e(s) + (o ? ": " : ":") + a);
                ...
                JSONDecode: (a = {
                    ...
                    throw{name: "SyntaxError", message: t, at: i, text: r}
                }, u = function (t) {
                    ...
                    if ("e" === o || "E" === o) for (e += o, u(), "-" !== o && "+" !== o || (e += o, u()); o >= "0" && o <= "9";) e += o, u();
                        ...
                        case"{":
                            return function () {
                                ...
                                if ("{" === o) {
                                    if (u("{"), l(), "}" === o) return u("}"), e;
                                    for (; o;) {
                                        if (t = p(), l(), u(":"), Object.hasOwnProperty.call(e, t) && c('Duplicate key "' + t + '"'), e[t] = s(), l(), "}" === o) return u("}"), e;
                                        u(","), l()
                                    }
                                }
                                c("Bad object")
                ...
                register_event: function () {
                    ...
                    return t.preventDefault = function () {
                        ...
                        if (e) if (e.addEventListener && !o) e.addEventListener(n, i, !1); else {
                            var r = "on" + n, s = e[r];
                            e[r] = function (e, n, i) {
                                return function (o) {
                ...
                cookie: {
                    get: function (t) {
                        for (var e = t + "=", n = f.cookie.split(";"), i = 0; i < n.length; i++) {
                        ...
                        var r = "", s = "", a = "";
                        if (i) {
                            var c = f.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i), u = c ? c[0] : "";
                            r = u ? "; domain=." + u : ""
                        }
                        if (n) {
                            var d = new Date;
                        ...
                        o && (a = "; secure"), f.cookie = t + "=" + encodeURIComponent(e) + s + "; path=/" + r + a
                    }, remove: function (t) {
                        var e = f.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i), n = e ? e[0] : "";
                        T.cookie.set(t, "", -1, "." + n)
                    }
                },
                info: {
                    campaignParams: function (t) {
                        ...
                        var e = "utm_source utm_medium utm_campaign utm_content utm_term".split(" "), n = "", i = {};
                        return T.each(e, function (e) {
                            ((n = T.getQueryParam(f.URL, e)).length || t[e]) && (i["$" + e] = t[e] || n)
                        }), i
        ...
        t.exports = o.extend({
            getRect: function (t, e) {
                var n = t.getBoundingClientRect(), i = this.css(t, "position");
                return {
                ...
                return o.isArray(t) ? t.forEach(function (t) {
                    this.css(t, {display: e || "block"})
                }, this) : this.css(t, {display: e || "block"}), t
            }, hide: function (t) {
                return o.isArray(t) ? t.forEach(function (t) {
                    this.css(t, {display: "none"})
                }, this) : this.css(t, {display: "none"}), t
            }, child: function (t) {
                ...
                return this.bind(t, e, function (t) {
                    var e = t.target, s = r.is(e, n);
                    if (s.flag) return i.call(o, t, s.target)
                }, o)
            }, scroll: function (t) {
                i.bind(t, "mousewheel", function (e) {
                    var n = this.getRect(t).height, i = t.scrollHeight;
                ...
                /absolute|fixed/.test(e) || this.css(t, {position: "relative"})
            }, locate: function (t, e) {
                var n = this.getRect(t, !0), i = this.getRect(e), o = {top: n.top, left: n.left + n.width};
                ...
                var e = this.getRect(this.body), n = this.getRect(t), i = n.top - e.height / 2,
                    o = n.left - e.width / 2;
        ...
        t.exports = {
            SESSION_KEYS: {PARAMS: "zhugeJsHeatMapParams"},
            URL: {DATA_LIST: "https://zhugeio.com/data/datalist.jsp"}
        }
    }, 5: function (t, e, n) {
        var i = n(0), o = {UNSENT: 0, OPENED: 1, HEADERS_RECEIVED: 2, LOADING: 3, DONE: 4};
            ...
            try {
                n.jsonp ? function (t, e) {
                    var n = function (t, n) {
                        ...
                        }, o = document.createElement("script"), s = "callback" + Math.random().toString().split(".")[1],
                        a = t + "?";
        ...
        var i = n(0), o = {
            prefix: {expand: "zhuge-auto-track-", interface: "zhuge-interface-"},
            body: document.getElementsByTagName("body")[0],
            ready: function (t, e) {
                if (this.body) t.call(e); else var n = this, i = setInterval(function () {
            ...
            bind: function (t, e, n, o) {
                ...
                if (t.addEventListener) t.addEventListener(e, r, !0); else if (t.attachEvent) t.attachEvent("on" + e, r); else {
                    var s = "on" + e, a = t[s];
                    t[s] = function (e) {
            ...
            setAttr: function (t, e, n) {
                if (i.isObject(e)) for (var o in e) t.setAttribute(o, e[o]); else t.setAttribute(e, n)
            },
            ...
            is: function (t, e) {
                ...
                return {flag: n, target: o}
            },
            isClickAble: function (t, e, n) {
                if (!t || this.isTextNode(t)) return {flag: !1};
                var o = this.getTagName(t), r = this.getAttr(t, "type"), s = this.isValidLink(t),
                    a = {flag: !1, target: t, isValidLink: s, form: null};
                switch (o) {
                    case"a":
                        if (s) {
                            a.flag = !0;
                    ...
                    case"body":
                        ...
                        break;
                    default:
                        if (this.hasBindClick(t) || i.isFunction(e) && e(t)) a.flag = !0; else if (!n) return this.isClickAble(this.getParent(t))
                }
                return a
            },
            ...
            query: function () {
                var t = "", e = window.document, n = /:eq\(\d+\)/g;
            ...
            loadJs: function (t) {
                t = i.extend({async: !0, src: "", onLoad: null, onError: null, context: null}, t || {});
                var e = document.createElement("script");
                this.setAttr(e, {
                    async: t.async,
                    src: t.src
                }), this.bind(e, "load", t.onLoad, t.context), this.bind(e, "error", t.onError, t.context), document.body.appendChild(e)
            }
        };
        t.exports = o
    }, 69: function (t, e, n) {
        var i = n(0), o = function (t, e) {
        ...
        t.exports = {
            ...
            SESSION_KEYS: {IS_ANALYSIS_MODE: "isZhugeVisualizerMode", PARAMS: "jsVisualizerParam"},
            URL: {
        ...
        var i = n(0), o = n(1), r = n(25);

        function s(t, e) {
            (this.config = i.extend({open: !1}, e || {}), this.tracker = t, this.loaded = !1, this.config.open) && (this._init(), "heatMap" === (window.sessionStorage.getItem("zhugeAnalysisModeType") || "") && this._initQueryParam())
        }
        ...
        s.prototype = {
            constructor: s, _init: function () {
                ...
                (window.opener || window.parent).postMessage({
                    ...
                    data: {rect: o.getRect(o.body)}
                }, "https://zhugeio.com")
            }, _onMessage: function (t) {
                var e = t.origin, n = t.data;
                ...
                if (!this.loaded) {
                    ...
                    o.loadJs({src: t + "?a=" + Math.random()})
                }
            }
        }, t.exports = s
    }, 71: function (t, e, n) {
        var i = n(0), o = n(6), r = n(5), s = n(7);
        ...
        a.prototype = {
            constructor: a, _init: function () {
                ...
                r("https://api.zhugeio.com/v2/visual", {
                    type: "get",
                    data: {url: location.href, app_key: this.tracker.getKey(), platform: 3},
                    context: this,
                    jsonp: !0,
                    success: function (t) {
                ...
                if ("https://zhugeio.com" === e) switch (n.command) {
                    case"openJsVisualizer":
                        window.opener.postMessage({command: "getQueryParam"}, e);
                        break;
                    case"getQueryParam":
                ...
                if (!this.loaded) {
                    this.loaded = !0, this.config.stopTrack(), window.sessionStorage.setItem(s.SESSION_KEYS.IS_ANALYSIS_MODE, JSON.stringify({flag: !0}));
                    var t = "https://static2-online.zhugeio.com/lib/sdk/visualizer.min.js".replace(/\"/g, "");
                    o.loadJs({src: t + "?a=" + Math.random()})
                }
            }, getEvent: function (t) {
                for (var e = [], n = 0, i = this.eventList.length; n < i; n++) for (var r = this.eventList[n], s = 0; s < r.element.length; s++) if (o.is(t.target, r.element[s]).flag) {
                    for (var a = {
                    ...
                    var d = {dt: "evt", eid: r.event_name, param: a};
                    e.push(d)
                }
                return e
            }
        ...
        var i = n(0), o = n(6), r = n(8), s = n(15), a = n(5);
        ...
        c.prototype = {
            constructor: c, _init: function () {
                ...
                var t = window.history, e = t.pushState, n = this;
                ...
                if ("https://zhugeio.com" === t.origin) {
                    ...
                    switch (e.command) {
                        ...
                        case"authorized":
                            ...
                            if (n === window) return;
                            n.postMessage({command: "hasOpenAutoTrackAnalysis"}, "https://zhugeio.com"), this._loadAnalysisCode();
                            break;
                        default:
                            console && console.warn("鏈瘑鍒殑message淇℃伅", e)
                    }
                }
            }, _onView: function () {
                var t = {$page_url: window.location.href, $page_title: window.document.title};
                ...
                if (e) {
                    ...
                    return this.config.isLanding && (i.$landing_page = !0), {dt: "abp", eid: "click", param: i}
                }
            }
        }, t.exports = c
    }, 73: function (t, e, n) {
        var i = n(0), o = n(5), r = n(72), s = n(71), a = n(70), c = n(6), u = n(69), d = [],
            p = ["identify", "track", "page"], l = null, h = function (t) {
                this.config = {}, i.extend(this.config, t), this.idle = 0, this.last_activity = new Date, this.is_landing = !1
            };
        h.prototype._init = function (t, e, n) {
            ...
            var r = this, s = function (t, e) {
                r._initDid(t), r.cookie = new u("zg_" + r._key, r.config);
                ...
                }, ""), r.cookie.register({superProperty: r.config.superProperty, platform: r.config.platform});
                var o = r._session(e);
                r.config.autoTrack && (r.is_landing = r._checkLanding(o)), r._info(), r._startPing(), r._initAutoTrack(), r.is_landing && r._initLanding(), r._startZgSee()
            };
            this.config.adTrack ? (r._wrapTrackerFunction(), i.jsonp("https://u.zhugeapi.net/v2/zgadtrack/header", function (t) {
                s(t.zg_adver_did, t.zg_adver_sid), n(), r._doTrackerQueue()
            }, function () {
                s(), n(), r._doTrackerQueue()
            })) : (s(), n())
        }, h.prototype._checkLanding = function (t) {
            if (this.config.autoTrack) {
                var e = !1, n = i.getDomain(location.href) !== i.getDomain(document.referrer);
                return t ? n && (e = !0, this.cookie.register({landHref: location.href})) : n && location.href === this.cookie.props.landHref && (e = !0), e
            }
        }, h.prototype._initLanding = function () {
            var t = this, e = function (e) {
                t.config.autoTrack && (l && clearTimeout(l), l = setTimeout(function () {
                    t.batchTrack([{
                        dt: "abp",
                        eid: "scroll",
                        param: {
            ...
            c.ready(function () {
                c.bind(window, "scroll", e)
            }, this)
        }, h.prototype._wrapTrackerFunction = function () {
            var t = this, e = {}, n = "", o = 0;
            for (o = 0; o < p.length; o++) e[n = p[o]] = h.prototype[n], h.prototype[n] = function (n) {
                return function () {
                    t.cookie ? i.isFunction(e[n]) && e[n].apply(t, arguments) : d.push([e[n], arguments])
                }
            }(n)
        }, h.prototype._doTrackerQueue = function () {
            var t = 0, e = null;
            for (t = 0; t < d.length; t++) e = d[t] || [], i.isFunction(e[0]) && e[0].apply(this, e[1] || []);
            d = []
        }, h.prototype._startZgSee = function () {
            var t = this;
            t.config.zgsee && o("https://ubak.zhugeio.com/appkey/" + this.getKey(), {
                type: "get",
                success: function (e) {
                    if (0 === e.policy || -1 === e.policy) {
                        window.zgsee = [{init: [e, t, o, i.cookie]}];
                        var n = new Date,
                            r = n.getFullYear().toString() + n.getMonth().toString() + n.getDate().toString();
                        c.loadJs({src: "https://zgsdk.zhugeio.com/zgsee.min.js?r=" + r})
                    }
                },
                error: function (t) {
                    console.error(t)
        ...
        }, h.prototype._initAutoTrack = function () {
            var t = !0, e = new s(this, {
                open: this.config.visualizer, stopTrack: function () {
                    t = !1
                }
            }), n = new r(this, {
            ...
            }), o = (new a(this, {open: this.config.autoTrack}), this), u = function (r) {
                if (t) {
                    var s = c.isClickAble(r.target, o.config.isClickAble);
                    if (s.flag) {
                        var a = [];
                        o.config.autoTrack && !i.hasMobileSdk().flag && a.push(n.getEvent(s)), o.config.visualizer && (a = e.getEvent(s).concat(a));
                        var u = r.target || r.srcElement || {}, d = u.clickedByZgSdk, p = c.getAttr(s.target, "target");
                        if (o.config.redirectAfterTrack && document.body.addEventListener && (!p || "_self" === p)) return !0 === d || !a.length || (o.batchTrack(a, function () {
                            u.clickedByZgSdk = !0, u.click()
                        }), !1);
                        a.length && o.batchTrack(a)
                    }
                }
            };
            c.ready(function () {
        ...
        }, h.prototype._session = function (t) {
            var e = !1, n = this.cookie.props.updated, o = this.cookie.props.sid, r = 1 * new Date, s = new Date;
            if (0 == o || r > n + 60 * this.config.session_interval_mins * 1e3) {
                if (o > 0 && n > 0) {
                    var a = {dt: "se", pr: {}};
                    a.pr.$ct = n, a.pr.$tz = 6e4 * -s.getTimezoneOffset(), a.pr.$dru = n - o, a.pr.$sid = o, a.pr.$cuid = this.cookie.props.cuid, this.cookie.register({
                        zs: 0,
                        sc: 0
                    }), this._batchTrack(a)
                }
                o = t || r, o *= 1;
                var c = {dt: "ss", pr: {}}, u = i.info.campaignParams(this.config.utm);
                c.pr = i.extend(c.pr, u), this.cookie.register({utm: i.JSONEncode(u)}, ""), c.pr.$ct = s.getTime(), c.pr.$sid = o, c.pr.$cuid = this.cookie.props.cuid, c.pr.$cn = this.config.app_channel, c.pr.$vn = this.config.app_version, c.pr.$tz = 6e4 * -s.getTimezoneOffset(), c.pr.$url = location.href, c.pr.$ref = document.referrer;
                var d = i.getDomain(document.referrer);
                c.pr.$referrer_domain = d, this.cookie.register({referrerDomain: d}, ""), this._batchTrack(c), this.cookie.register({sid: o}, ""), e = !0
            }
            return this.cookie.register({updated: r}, ""), e
        }, h.prototype._info = function (t) {
            var e = this.cookie.props.info, n = 1 * new Date;
            if (n > e + 24 * this.config.info_upload_interval_days * 60 * 60 * 1e3 || t) {
                var o = {dt: "pl", pr: {$rs: i.info.resolution()}}, r = new Date;
                o.pr.$tz = 6e4 * -r.getTimezoneOffset(), o.pr.$ct = r.getTime(), o.pr.$cuid = this.cookie.props.cuid, o.pr = i.extend(o.pr, i.encode(i.JSONDecode(this.cookie.props.platform))), 1 === this.cookie.props.zs && (o.pr.$zs = 1), this._batchTrack(o), this.cookie.register({info: n}, "")
            }
        }, h.prototype.debug = function (t) {
            this.config.debug = t
        }, h.prototype.identify = function (t, e, n) {
            t += "";
            var o = i.isObject(e) ? e : {}, r = i.isObject(e) ? n : e;
            this.cookie.register({cuid: t}, ""), this._session();
            var s = i.hasMobileSdk();
            if (s.flag) s.identify(t, o), i.isFunction(r) && r(); else {
                var a = {dt: "usr", pr: {}}, c = new Date;
        ...
        }, h.prototype.track = function (t, e, n) {
            var o = i.isObject(e) ? e : {}, r = i.isObject(e) ? n : e, s = i.hasMobileSdk();
            s.flag ? (s.track(t, o), i.isFunction(r) && r()) : this.batchTrack([{dt: "evt", eid: t, param: o}], r)
        }, h.prototype.batchTrack = function (t, e) {
            this._session();
        ...
        }, h.prototype._moved = function (t) {
            this.last_activity = new Date, this.idle = 0
        }, h.prototype._startPing = function () {
            var t = this;
        ...
        }, h.prototype.getDid = function () {
            return this.did.props.did
        }, h.prototype.getSid = function () {
            return this.cookie.props.sid
        }, h.prototype.setSuperProperty = function (t) {
            i.isObject(t) && this.cookie.register({superProperty: i.JSONEncode(t)})
        }, h.prototype.setPlatform = function (t) {
            i.isObject(t) && (this.cookie.register({platform: i.JSONEncode(t), info: 0}), this._info())
        }, h.prototype._batchTrack = function (t, e) {
            if (!i.hasMobileSdk().flag) {
                var n = {}, o = new Date;
                n.sln = "itn", n.pl = "js", n.sdk = "zg-js", n.sdkv = "2.0", n.owner = "zg", n.ut = [o.getFullYear(), o.getMonth() + 1, o.getDate()].join("-") + " " + o.toTimeString().match(/\d{2}:\d{2}:\d{2}/)[0], n.tz = 6e4 * -o.getTimezoneOffset(), n.debug = this.config.debug ? 1 : 0, n.ak = this._key, n.usr = {did: this.did.props.did};
                var r = [];
                i.isArray(t) ? r = t : r.push(t), n.data = r, this._sendTrackRequest(n, this._prepareCallback(e, n))
            }
        }, h.prototype._prepareCallback = function (t, e) {
            if (!i.isFunction(t)) return null;
            return function (n) {
                t(n, e)
            }
        }, h.prototype._initDid = function (t) {
            var e = i.cookie.get("_zg");
            t = t || i.UUID();
            e && i.JSONDecode(e).uuid && (t = i.JSONDecode(e).uuid), i.cookie.get("zg_did") || i.cookie.remove("zg_" + this._key), this.did = new u("zg_did", this.config), this.did.register_once({did: t}, "")
        }, h.prototype._sendTrackRequest = function (t, e) {
            var n = i.truncate(t, 255), r = {event: i.JSONEncode(n), _: (new Date).getTime().toString()}, s = {
                bac: this.config.api_host_bac + "&" + i.HTTPBuildQuery(r),
                normal: this.config.api_host + "&" + i.HTTPBuildQuery(r)
            };
            t.data.length && "zgsee" === t.data[0].dt ? o("https://ubak.zhugeio.com/zgsee", {
                type: "post",
                data: {method: "web_event_srv.upload", compress: 0, event: t}
            }) : this._sendRequest(s, e)
        }, h.prototype._sendRequest = function (t, e) {
            var n = new Image, i = !1, o = setTimeout(function () {
                !i && e && (e(), i = !0)
            }, 500), r = function () {
        ...
        for (var r = window.zhuge || [], s = new i(DEFAULT_CONFIG), a = 0; a < r.length; a++) if ("_init" === r[a][0]) {
            var c = r.shift(), u = c.shift();
            c.push(function () {
                for (; r && r.length > 0;) {
                    var t = r.shift(), e = t.shift();
                    s[e] && s[e].apply(s, t)
                }
            }), s[u] && s[u].apply(s, c);
            break
        ...
        if (s.config.deepShare) {
            var d = new Date, p = d.getFullYear().toString() + d.getMonth().toString() + d.getDate().toString();
            o.loadJs({src: "https://zgsdk.zhugeio.com/deepshare.min.js?v=" + p, onLoad: s.config.onLoadDeepShare})
        }
        s.env = Object({
            ...
            ZGSEE_SDK_SRC: "https://zgsdk.zhugeio.com/zgsee.min.js"
        }), window.zhuge = s
    }, 8: function (t, e) {
        function n(t, e) {
        ...
        t.exports = function (t, e, n) {
            return e ? n ? f(e, t) : p(f(e, t)) : n ? h(t) : p(h(t))
        }
    }
});